...
_UPDATE_I18N = {
    'en': {
        'lbl_auto_check_updates':    'Auto check for updates',
        'tt_auto_check_updates':     'Automatically check for a new BadWords release on every startup.',
        ...
        'update_notify_btn_dismiss': "Don't check again",
    },
    'pl': {
        'lbl_auto_check_updates':    'Automatycznie sprawdzaj aktualizacje',
        'tt_auto_check_updates':     'Automatycznie sprawdza nowe wersje BadWords przy każdym uruchomieniu.',
        ...
        'update_notify_btn_dismiss': 'Nie sprawdzaj ponownie',
    },
    'de': {
        'lbl_auto_check_updates':    'Automatisch auf Updates prüfen',
        'tt_auto_check_updates':     'Prüft bei jedem Start automatisch auf neue BadWords-Versionen.',
        ...
        'update_notify_btn_dismiss': 'Nicht mehr prüfen',
    },
    'es': {
        'lbl_auto_check_updates':    'Buscar actualizaciones automáticamente',
        'tt_auto_check_updates':     'Comprueba automáticamente nuevas versiones de BadWords al iniciar.',
        ...
        'update_notify_btn_dismiss': 'No volver a comprobar',
    },
    'fr': {
        'lbl_auto_check_updates':    'Vérifier les mises à jour automatiquement',
        'tt_auto_check_updates':     'Vérifie automatiquement les nouvelles versions de BadWords au démarrage.',
        ...
        'update_notify_btn_dismiss': 'Ne plus vérifier',
    },
    'it': {
        'lbl_auto_check_updates':    'Controlla aggiornamenti automaticamente',
        'tt_auto_check_updates':     'Controlla automaticamente nuove versioni di BadWords ad ogni avvio.',
        ...
        'update_notify_btn_dismiss': 'Non controllare più',
    },
    'pt': {
        'lbl_auto_check_updates':    'Verificar atualizações automaticamente',
        'tt_auto_check_updates':     'Verifica automaticamente novas versões do BadWords a cada inicialização.',
        ...
        'update_notify_btn_dismiss': 'Não verificar novamente',
    },
    'uk': {
        'lbl_auto_check_updates':    'Автоматично перевіряти оновлення',
        'tt_auto_check_updates':     'Автоматично перевіряє наявність нових версій BadWords при кожному запуску.',
        ...
        'update_notify_btn_dismiss': 'Більше не перевіряти',
    },
    'nl': {
        'lbl_auto_check_updates':    'Automatisch controleren op updates',
        'tt_auto_check_updates':     'Controleert bij elke start automatisch op nieuwe BadWords-versies.',
        ...
        'update_notify_btn_dismiss': 'Niet meer controleren',
    },
    'ru': {
        'lbl_auto_check_updates':    'Автоматически проверять обновления',
        'tt_auto_check_updates':     'Автоматически проверяет наличие новых версий BadWords при каждом запуске.',
        ...
        'update_notify_btn_dismiss': 'Больше не проверять',
    },
}
